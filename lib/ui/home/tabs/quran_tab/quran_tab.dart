    ...
    return Column(
      children: [
        Expanded(
            flex: 1,
            child: Image.asset(
                getImagePathByName(imageName: 'quran_header_icn.png'))),
        Container(
            ...
            child: Row(
              ...
              children: [
                Text(AppLocalizations.of(context)!.chapterName,
        ...
        Expanded(
          ...
          child: ListView.separated(
              itemBuilder: (context, index) {
                return SuraTitleWidget(
                  suraTitle: suraNames[index],
                  suraVerses: surahVerses[index].toString(),
                  index: index,
                );
              },
